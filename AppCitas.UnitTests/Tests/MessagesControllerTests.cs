...
namespace AppCitas.UnitTests.Tests
{
    public class MessagesControllerTests
    {
        ...
        [Theory]
        [InlineData("BadRequest", "wagner", "Pa$$w0rd", "wagner", ":D")]
        ...
        [Theory]
        [InlineData("NotFound", "wagner", "Pa$$w0rd", "profemeza", ":c")]
        ...
        [Theory]
        [InlineData("OK", "todd", "Pa$$w0rd", "louise", ":0")]
        ...
        [Theory]
        [InlineData("OK", "esmeralda", "Pa$$w0rd", "hewitt", "Messi")]
        ...
        [Theory]
        [InlineData("Unauthorized", "rosa", "Pa$$w0rd", "berry", "Hello", "lisa")]
