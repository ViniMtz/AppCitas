...
namespace AppCitas.UnitTests.Tests
{
    public class UsersControllerTests
    {
        ...
        [Theory]
        [InlineData("OK", "todd", "Pa$$w0rd",1,10)]
        ...
        [Theory]
        [InlineData("Created", "wagner", "Pa$$w0rd", "../../../img.jpg")]
        ...
        [Theory]
        [InlineData("NoContent", "hewitt", "Pa$$w0rd", "../../../img2.jpg")]
        ...
        [Theory]
        [InlineData("NotFound", "berry", "Pa$$w0rd", "20")]
